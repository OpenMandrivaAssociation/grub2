...
Patch19:	0001-Revert-Make-grub-install-check-for-errors-from-efibo.patch
#Patch20:	temp-installh-fix-for-double-declaration.patch
...
%define grub_modules_default chain configfile echo efifwsetup efinet ext2 f2fs fat font gfxmenu gfxterm gfxterm_background gfxterm_menu gzio halt hfsplus iso9660 jpeg loadenv loopback linux lsefi lua lvm mdraid09 mdraid1x minicmd normal part_apple part_gpt part_msdos password_pbkdf2 png reboot regexp search search_fs_file search_fs_uuid search_label serial sleep sleep squash4 syslinuxcfg test tftp video xfs btrfs
...
%define grub_modules grub-core linux multiboot multiboot2 all_video boot %{grub_modules_default} cat
%endif
